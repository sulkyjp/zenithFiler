...
### Added
- **超コンパクト行高**: ファイル一覧の行高に「超コンパクト (20px)」を追加。一度に多くのファイルを表示可能に

## [0.26.2] - 2026-03-07

### Fixed
- **バージョン情報表示修正**: About ページのバージョン番号が表示されない問題を修正（バインディングパス誤り）

### Added
- **更新内容表示**: About ページに現在バージョンの CHANGELOG エントリを表示するセクションを追加
...
- 2回目以降の起動時に表示されていた個別の使用許諾契約ダイアログを削除（初回起動のウェルカムウィンドウに統合済み）
